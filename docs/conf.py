# -*- coding: utf-8 -*-
#
# pyramid_handlers documentation build configuration file
#
...
html_theme = 'pyramid'
html_theme_options = {'github_url':'http://github.com/Pylons/pyramid_handlers/'}
...
latex_documents = [
  ('index', 'pyramid_handlers.tex', 'pyramid_handlers Documentation',
